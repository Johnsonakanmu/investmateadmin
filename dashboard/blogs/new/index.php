                ...
                <div class="card position-relative border-0">
                  ...
                  <div class="card-footer p-0 border-top border-translucent">
                    <ul class="nav d-flex flex-column my-3">
                      <li class="nav-item"><a class="nav-link px-3 d-block" href="../../users/new/index.php"> <span class="me-2 text-body align-bottom" data-feather="user-plus"></span>Add another account</a></li>
                    </ul>
                    <hr>
                ...
                <select class="form-select" name="caption" style="height: 50px;" required  id="caption">
                  <option selected="selected">Choose...</option>
                    <?php foreach ($captions as $caption): ?>
                        <option value="<?php echo htmlspecialchars($caption); ?>">
